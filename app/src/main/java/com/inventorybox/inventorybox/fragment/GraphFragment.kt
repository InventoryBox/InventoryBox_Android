...
import com.inventorybox.inventorybox.adapter.GraphCalendarAdapter
import com.inventorybox.inventorybox.adapter.GraphCategoryRVAdapter
import com.inventorybox.inventorybox.R
import com.inventorybox.inventorybox.adapter.GraphSingleGraphAdapter
...
//        Log.d("graphFragment", "${rv_adapter.today}")
        ...
        val categoryListener = object : CategoryClickListener{
            override fun onClick(category_idx: Int, category_name: String) {
                if(category_name!= "전체"){
...
//                Log.d("network_success","$datas_graph")
     ...
     interface CategoryClickListener{
         fun onClick(category_idx : Int, category_name : String)
     }
}
