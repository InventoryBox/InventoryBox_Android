...
import com.inventorybox.inventorybox.Adpater.RecordCompletedAdapter
import com.inventorybox.inventorybox.DB.SharedPreferenceController

import com.inventorybox.inventorybox.R
import com.inventorybox.inventorybox.activity.RecordCateogyActivity
import com.inventorybox.inventorybox.activity.RecordModifyActivity
import com.inventorybox.inventorybox.activity.RecordRecordActivity
import com.inventorybox.inventorybox.adapter.RecordCategoryAdapter
import com.inventorybox.inventorybox.data.RecordHomeCategoryInfo
import com.inventorybox.inventorybox.data.RecordHomeItemInfo
import com.inventorybox.inventorybox.etc.RecordDatePicker
import com.inventorybox.inventorybox.etc.RecordDatePicker.Companion.cal
...
class RecordFragment : Fragment() {
    ...
    val category_listener = object : CategoryClickListener{
        override fun onClick(category_idx: Int, categoryName : String) {
            if(categoryName != "전체"){
...
//        m_date =   current.format(DateTimeFormatter.ofPattern("dd")).toString()
    ...
    interface CategoryClickListener{
        fun onClick(category_idx : Int, categoryName : String)
    }
}