...
import com.inventorybox.inventorybox.fragment.onMyChangeListener
...
//            listener.onChange(adapterPosition, true)
    ...
    fun backgroundToYellow(){
        ...
        itemView.background.setTint(com.inventorybox.inventorybox.graph.getColorFromRes(itemView.context, R.color.yellow))
    ...
    fun backgroundToGrey(){
        ...
        itemView.background.setTint(com.inventorybox.inventorybox.graph.getColorFromRes(itemView.context, R.color.white))
    }

    fun deactivate(){
        itemView.background.setTint(com.inventorybox.inventorybox.graph.getColorFromRes(itemView.context, R.color.middlegrey))
        tv_week.setTextColor(itemView.context.getColorFromRes(R.color.white))
        isClicked=false
    }
    fun activate(){
